...
local currencyIcons = {
    [CURT_TELVAR_STONES] = ZO_Currency_GetKeyboardFormattedCurrencyIcon(CURT_TELVAR_STONES, 24), --Tel'Var Stones
    [CURT_ALLIANCE_POINTS] = ZO_Currency_GetKeyboardFormattedCurrencyIcon(CURT_ALLIANCE_POINTS, 24), --Alliance Points
}
